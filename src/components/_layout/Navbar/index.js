...
import face2 from '../../../assets/images/faces/face4.jpg';
import face3 from '../../../assets/images/faces/face4.jpg';
import face4 from '../../../assets/images/faces/face4.jpg';
import face15 from '../../../assets/images/faces/face4.jpg';
        ...
        return (
            <nav className="navbar p-0 fixed-top d-flex flex-row">
                <div className="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
                    <a className="navbar-brand brand-logo-mini" href="index.html"><img src={logo}
                                                                                       alt="logo"/></a>
                </div>
                <div className="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
                    ...
                    <ul className="navbar-nav navbar-nav-right">
                        <li className="nav-item dropdown d-none d-lg-block">
                            <a className="nav-link btn btn-success create-new-button" id="createbuttonDropdown" href="/users/list"
                               data-toggle="dropdown" aria-expanded="false" >+ Create New Project</a>
                            <div className="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                                ...
                                <a className="dropdown-item preview-item" href="/users/list">
                        ...
                        <li className="nav-item nav-settings d-none d-lg-block">
                            <a className="nav-link" href="/users/list">
                                <i className="mdi mdi-view-grid"></i>
                            </a>
                        </li>
                        <li className="nav-item dropdown border-left">
                            <a className="nav-link count-indicator dropdown-toggle" id="messageDropdown" href="/users/list"
                        ...
                        <li className="nav-item dropdown border-left">
                            <a className="nav-link count-indicator dropdown-toggle" id="notificationDropdown" href="/users/list"
                        ...
                        <li className="nav-item dropdown">
                            <a className="nav-link" id="profileDropdown" href="/users/list" data-toggle="dropdown">
                            ...
                            <div className="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                                ...
                                <div className="dropdown-divider"></div>
                                <Link to='/logout' className="dropdown-item preview-item">
                                    <div className="preview-thumbnail">
                                        <div className="preview-icon bg-dark rounded-circle">
